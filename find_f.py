...
def calc(x, y, grid_name="r075"):
    ...
    Parameters:
        ...
        grid_name (str): Name of the grid to use (default is 'ro5' which grabs the all points within a radius of r=0.05). Other grids are: 'r025', 'r05', r075', and 'r1'. If a point falls outside the model space, then we grab the nearest 20 points.
